  ...
  try {
    ...
    if (isKie) {
      ...
      const staticKieModels: UpstreamModel[] = [
        ...
        // GPT Image 2 (text-to-image, legacy alias without resolution tier)
        { id: "gpt-image-2", displayName: "GPT Image 2", capabilities: ["image"], costInputPer1k: 0.024, inputPricePer1k: 0.03 },
        // GPT Image 2 text-to-image: resolution-tiered for correct billing.
        // Client sends model="gpt-image-2-text-to-image" + input.resolution="1K"/"2K"/"4K"
        // Platform routes to the correct tier; upstream always uses "gpt-image-2-text-to-image".
        // KIE constraint: aspect_ratio=auto only allows 1K; 1:1 + 4K is forbidden.
        ...
        { id: "gpt-image-2-text-to-image-1k",  displayName: "GPT Image 2 Text-to-Image 1K",  capabilities: ["image"], costInputPer1k: 0.024, inputPricePer1k: 0.03 },
        { id: "gpt-image-2-text-to-image-2k",  displayName: "GPT Image 2 Text-to-Image 2K",  capabilities: ["image"], costInputPer1k: 0.06,  inputPricePer1k: 0.075 },
        { id: "gpt-image-2-text-to-image-4k",  displayName: "GPT Image 2 Text-to-Image 4K",  capabilities: ["image"], costInputPer1k: 0.08,  inputPricePer1k: 0.10 },
